...
setInterval(function (){
  var item = document.querySelectorAll('.carItem img')
  item[i].style.transition = 'all 0.5s'
  item[i].style.transform = 'perspective(500px) translate3d(-8px, 0px, 50px) rotate3d(0, -1, 0, 40deg)'
    if(i>= 4){
      i = 0
    }
  item[i++].style.transition = 'all 0.5s'
  item[i].style.transform = 'perspective(500px) translate3d(-15px, 0px, 100px) rotate3d(0, -1, 0, 20deg)'
  if(i>= 4){
    i = 0
  }
  item[i++].style.transition = 'all 0.5s'
  item[i].style.transform = 'perspective(500px) translate3d(0px, 0px, 150px) rotate3d(0, 0, 0, 40deg)'
  if(i>= 4){
    i = 0
  }
  item[i++].style.transition = 'all 0.5s'
